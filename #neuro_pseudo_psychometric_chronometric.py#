...
for hh in range(len(monkeys)):
    ...
    for ii in range(n_rand):
        ...
        if monkeys[hh]=='Galileo':
            n_max=96*4*3 # 96 channels, 4 files, 3 time steps
    ...
    ax.plot(xx_fit_coh,fit_psycho_neuro_flat_m[:,0],color='black')
    ax.fill_between(xx_fit_coh,fit_psycho_neuro_flat_m[:,0]-fit_psycho_neuro_flat_std[:,0],fit_psycho_neuro_flat_m[:,0]+fit_psycho_neuro_flat_std[:,0],color='black',alpha=0.5)
    ax.scatter(xx_coh,psycho_neuro_flat_m[:,1],color='green',s=3)
    ax.plot(xx_fit_coh,fit_psycho_neuro_flat_m[:,1],color='green')
    ax.fill_between(xx_fit_coh,fit_psycho_neuro_flat_m[:,1]-fit_psycho_neuro_flat_std[:,1],fit_psycho_neuro_flat_m[:,1]+fit_psycho_neuro_flat_std[:,1],color='green',alpha=0.5)
    ax.scatter(xx_coh,psycho_neuro_flat_m[:,2],color='blue',s=3)
    ax.plot(xx_fit_coh,fit_psycho_neuro_flat_m[:,2],color='blue')
    ax.fill_between(xx_fit_coh,fit_psycho_neuro_flat_m[:,2]-fit_psycho_neuro_flat_std[:,2],fit_psycho_neuro_flat_m[:,2]+fit_psycho_neuro_flat_std[:,2],color='blue',alpha=0.5)
    ...
    chrono_neuro_all[hh,0,ind_put]=chrono_neuro_flat_m[ind_ext]
    chrono_neuro_all[hh,1,ind_put]=chrono_neuro_flat_std[ind_ext]
...
ax.plot(xx_fit_coh,fit_psycho_neuro_m[:,1],color='green')
ax.fill_between(xx_fit_coh,fit_psycho_neuro_m[:,1]-fit_psycho_neuro_std[:,1],fit_psycho_neuro_m[:,1]+fit_psycho_neuro_std[:,1],color='green',alpha=0.5)
ax.scatter(xx_coh,psycho_neuro_m[:,2],color='blue',s=3)
ax.plot(xx_fit_coh,fit_psycho_neuro_m[:,2],color='blue')
ax.fill_between(xx_fit_coh,fit_psycho_neuro_m[:,2]-fit_psycho_neuro_std[:,2],fit_psycho_neuro_m[:,2]+fit_psycho_neuro_std[:,2],color='blue',alpha=0.5)
ax.plot(xx_coh,0.5*np.ones(15),color='black',linestyle='--')
ax.axvline(0,color='black',linestyle='--')
ax.set_ylabel('Probability Right Response')
ax.set_xlabel('Motion Strength (% Coh.)')
...
ax.plot(xx_fit_coh,fit_chrono_neuro_m[:,0],color='black')
ax.fill_between(xx_fit_coh,fit_chrono_neuro_m[:,0]-fit_chrono_neuro_std[:,0],fit_chrono_neuro_m[:,0]+fit_chrono_neuro_std[:,0],color='black',alpha=0.5)
ax.scatter(xx_coh,chrono_neuro_m[:,1],color='green',s=3)
ax.plot(xx_fit_coh,fit_chrono_neuro_m[:,1],color='green')
ax.fill_between(xx_fit_coh,fit_chrono_neuro_m[:,1]-fit_chrono_neuro_std[:,1],fit_chrono_neuro_m[:,1]+fit_chrono_neuro_std[:,1],color='green',alpha=0.5)
ax.scatter(xx_coh,chrono_neuro_m[:,2],color='blue',s=3)
ax.plot(xx_fit_coh,fit_chrono_neuro_m[:,2],color='blue')
ax.fill_between(xx_fit_coh,fit_chrono_neuro_m[:,2]-fit_chrono_neuro_std[:,2],fit_chrono_neuro_m[:,2]+fit_chrono_neuro_std[:,2],color='blue',alpha=0.5)
ax.axvline(0,color='black',linestyle='--')
ax.plot(xx_coh,0*np.ones(15),color='black',linestyle='--')
ax.set_ylabel('Distance to Boundary')
ax.set_xlabel('Motion Strength (% Coh.)')
#plt.xticks(xx_coh,coh_plot[0])
plt.xticks([-2.54,0,2.54],['-12.8','0','12.8'])
