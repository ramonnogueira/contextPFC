...
# This function outputs a vector with two rows
# - First row is whether response == new context for stimulus 0 (left)
# - Second row is whether response == new context for stimulus 1 (right)
# Because each trial is either stimulus left or right only, half each row will be empty (nan)
