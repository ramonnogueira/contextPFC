...
def func_eval_behav(index,t_back,t_forw,stimulus,context,rt):
    ...
    for j in range(t_forw):
        ...
        try:
            if stimulus[indj]==0:
                pp[0,j+t_back]=rt[indj]
            if stimulus[indj]==1:
                pp[1,j+t_back]=rt[indj]
        except:
            None
    return pp
...
for hh in range(len(files_groups)):
    ...
    for kk in range(len(files)):
        ...
        for h in range(len(ind_ch01_s0)):
            cc_01_0=func_eval_behav(ind_ch01_s0[h],t_back,t_forw,stimulus,context,rt)
        ...
        for h in range(len(ind_ch01_s1)):
            cc_01_1=func_eval_behav(ind_ch01_s1[h],t_back,t_forw,stimulus,context,rt)
        ...
        for h in range(len(ind_ch10_s0)):
            cc_10_0=func_eval_behav(ind_ch10_s0[h],t_back,t_forw,stimulus,context,rt)
        ...
        for h in range(len(ind_ch10_s1)):
            cc_10_1=func_eval_behav(ind_ch10_s1[h],t_back,t_forw,stimulus,context,rt)
