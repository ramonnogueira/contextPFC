...
tested=np.concatenate((np.array(beha_tested_rlow),-1*np.array(beha_tested_rhigh)))
untested=np.concatenate((np.array(beha_untested_rlow),-1*np.array(beha_untested_rhigh)))
aa=np.concatenate((tested,untested))

#Significantly Above 0
print ('Significantly Above 0 ')
print ('All ',np.mean(aa),sem(aa),scipy.stats.wilcoxon(aa,alternative='greater'))
print ('Tested ',np.mean(tested),scipy.stats.wilcoxon(tested,alternative='greater'))
print ('Untested ',np.mean(untested),scipy.stats.wilcoxon(untested,alternative='greater'))

# Difference tested and untested combined
#print ('Difference ',scipy.stats.ttest_ind(tested,untested,alternative='two-sided'))
print ('Difference ',scipy.stats.mannwhitneyu(tested,untested,alternative='two-sided'))

# Low Reward is different than High Reward
print ('##### Tested')
print ('Low R: ',np.mean(beha_tested_rlow),sem(beha_tested_rlow),len(beha_tested_rlow))
print ('High R: ',np.mean(beha_tested_rhigh),sem(beha_tested_rhigh),len(beha_tested_rhigh))
print ('Mannwhitneyu difference ',scipy.stats.mannwhitneyu(beha_tested_rlow,beha_tested_rhigh,alternative='greater'))
print ('T test difference ',scipy.stats.ttest_ind(beha_tested_rlow,beha_tested_rhigh,alternative='greater'))

print ('##### Untested')
print ('Low R: ',np.mean(beha_untested_rlow),sem(beha_untested_rlow),len(beha_untested_rlow))
